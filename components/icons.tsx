...
// FIX: All icon components have been updated to accept props. This allows them to be customized
// (e.g., by overriding the className), which resolves a TypeScript error in Header.tsx where
// React.cloneElement was used to pass props to components that did not accept them.
export const DashboardIcon = (props: React.ComponentProps<'svg'>) => (
  <svg {...iconProps} {...props}><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"></path><polyline points="9 22 9 12 15 12 15 22"></polyline></svg>
);
...
export const SearchIcon = (props: React.ComponentProps<'svg'>) => (
  <svg className="h-5 w-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>
);

export const PlusCircleIcon = (props: React.ComponentProps<'svg'>) => (
  <svg className="h-5 w-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><circle cx="12" cy="12" r="10"></circle><line x1="12" y1="8" x2="12" y2="16"></line><line x1="8" y1="12" x2="16" y2="12"></line></svg>
);
...
export const UserPlusIcon = (props: React.ComponentProps<'svg'>) => (
  <svg className="h-5 w-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
...
export const MoreHorizontalIcon = (props: React.ComponentProps<'svg'>) => (
  <svg className="h-5 w-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
